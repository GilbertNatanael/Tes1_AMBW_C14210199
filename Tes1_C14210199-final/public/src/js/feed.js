...
function createCard(data) {
  ...
  cardWrapper.className = 'shared-moment-card col col-md-8';
...
// Assuming cardTitle is a reference to the title element
cardTitle.style.backgroundImage = 'url(' + data.image + ')';
cardTitle.style.backgroundSize = 'cover';
cardTitle.style.backgroundPosition = 'center'; // Center the background image
cardTitle.style.height = '350px'; 
cardTitle.style.width = '1100px';
